...
- a semantic tag such as `v0.12.2`;
...
leading `v`, for example `0.12.2` or `v0.12.2`. It rejects two-part,
four-part, suffixed, or otherwise malformed values. Do not rely on a tag such
as `v0.12.2-beta` being normalized into the public update channel.
...
passes. For 0.12.2, use
[`releases/0.12.2/TEST_PLAN.md`](releases/0.12.2/TEST_PLAN.md). Historical 0.11
