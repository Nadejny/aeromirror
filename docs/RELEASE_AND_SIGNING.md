...
- a semantic tag such as `v0.12.6`;
...
leading `v`, for example `0.12.6` or `v0.12.6`. It rejects two-part,
four-part, suffixed, or otherwise malformed values. Do not rely on a tag such
as `v0.12.6-beta` being normalized into the public update channel.
...
passes. For the 0.12.6 candidate, use
[`releases/0.12.6/TEST_PLAN.md`](releases/0.12.6/TEST_PLAN.md). Historical 0.11
